...
Please see <<a3252, Full Jakarta™ EE Product Requirements>> for the specific versions required for each component.
...
=== Expression Language  (EL) Requirements
...
=== RESTful Web Services Requirements
...
=== WebSocket (WebSocket) Requirements
...
=== JSON Processing (JSON-P) Requirements
...
=== JSON Binding (JSON-B) Requirements
...
=== Concurrency (Concurrency Utilities) Requirements
...
=== Batch Specification Requirements
...
=== Debugging Support for Other Languages Requirements
...
=== Contexts and Dependency Injection (CDI) Requirements
...
=== Enterprise Web Services Requirements (Optional)
...
=== XML Binding Requirements (Optional)
...
=== XML Web Services Requirements (Optional)
...
=== Web Services Metadata Requirements (Optional)

This specification is moved to XML Web Services.
...
=== SOAP with Attachments Requirements (Optional)
